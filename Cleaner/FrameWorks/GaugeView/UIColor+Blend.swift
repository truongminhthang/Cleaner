...
func + (left: UIColor, right: UIColor) -> UIColor {
    var lRed : CGFloat = 0.0
    var lGreen : CGFloat = 0.0
    var lBlue : CGFloat = 0.0
    var lAlpha: CGFloat = 0.0

    var rRed : CGFloat = 0.0
    var rGreen : CGFloat = 0.0
    var rBlue : CGFloat = 0.0
    var rAlpha: CGFloat = 0.0
